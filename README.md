...
Make sure you configured everything for your clock in the `_USER_DEFINES.h` in the `includes` folder:
...
The output file is written to the default output dir of the build. Usually the subfolder `.pio\build\<environment name>` in the project folder.
